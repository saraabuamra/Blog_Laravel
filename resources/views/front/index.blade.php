...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a style="position: relative;left:100px" href="index.html" class="logo d-flex align-items-center">
        <img src="{{asset('front/assets/img/logo.svg')}}" alt="">
        <span>معلمك</span>
      </a>

      <nav style="position: relative;left:60px" id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">الرئيسية</a></li>
          <li><a class="nav-link scrollto" href="#about">من أنا</a></li>
          <li><a class="nav-link scrollto" href="#services">مقالاتي</a></li>
          <li><a class="nav-link scrollto" href="#portfolio">قصائدي</a></li>
          <li><a class="nav-link scrollto" href="#team">قنوات اليوتيوب</a></li>
          ...
          <li class="dropdown"><a href="#"><span>مؤهلاتي العلمية</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>الشهادات</span> <i class="bi bi-chevron-left"></i></a>
                <ul>
                  <li><a href="#">Deep Drop Down 1</a></li>
                  <li><a href="#">Deep Drop Down 2</a></li>
                  <li><a href="#">Deep Drop Down 3</a></li>
              ...
              <li class="dropdown"><a href="#"><span>الخبرات</span> <i class="bi bi-chevron-left"></i></a>
                <ul>
                  <li><a href="#">Deep Drop Down 1</a></li>
                  <li><a href="#">Deep Drop Down 2</a></li>
                  <li><a href="#">Deep Drop Down 3</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h5 data-aos="fade-up">حياك الله في موقعي</h5>
          <h1 data-aos="fade-up">@if (isset($admin['name'])) {{$admin['name']}} @endif</h1>
          <br/>
          <h4 data-aos="fade-up" data-aos-delay="400">مشرف تربوي يجمع بين الخبرة والاحترافية في مجال التعليم,متخصص في تقديم استشارات موثوقة وفعالة .</h4>
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-end">
              <a href="#about" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span>استشارة</span>&numsp;&numsp;&numsp;
    ...
    <section id="recent-blog-posts" class="recent-blog-posts">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="post-box">
              <div class="post-img"><img src="{{asset('front/assets/img/blog/blog-1.jpg')}}" class="img-fluid" alt=""></div>
