      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#about" class="btn-get-started scrollto">إستشارة</a>
            <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i>&numsp;<span>قناتي</span></a>
          </div>
          @endforeach
        </div>
        ...
        <div class="row content">
            <div class="col-lg-7">
                ...
                <ul>
                    ...
                    <li>&numsp;&numsp;&numsp;<i class="ri-check-double-line">
